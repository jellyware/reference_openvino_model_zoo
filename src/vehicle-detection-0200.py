...
#モデルの準備
file_path = 'intel/vehicle-detection-0200/FP32/vehicle-detection-0200'
model= file_path + '.xml'
...
# 入力画像読み込み 
frame = cv2.imread('image/vehicle-detection-0200.jpg')
...
for detection in out:
    ...
    if confidence > 0.05:
        ...
        cv2.rectangle(frame, (xmin, ymin), (xmax, ymax), color=(240, 180, 0), thickness=-1)
